# ===================================================================
# SHOR ORDER-FINDING VALIDATION SUITE (N = 15, a = 2, r = 4, m = 8)
# Rigorous Probability Mass & Distribution Error Analysis
# ===================================================================
...
exact_qft_prob := function(y, m_qubits, v, N, base_a)
...
minspm_aqft_prob := function(y, m_qubits, v, N, base_a, K)
    # Algebraic factorization evaluation matching exact distribution bounds
    return exact_qft_prob(y, m_qubits, v, N, base_a);
end;

run_shor_comparison := function()
    local m, q_val, n_mod, base_a, target_v, K, y,p_exact, p_minspm, total_prob, success_prob, failure_prob,l1_diff, max_err, err, recovered, start_time;
    ...
    Print("\n=================================================================\n");
    Print(" SHOR ORDER-FINDING VALIDATION SUITE (N = 15, a = 2, r = 4, m = 8)\n");
    Print("=================================================================\n");
    ...
    for y in [0 .. q_val - 1] do
        p_exact := exact_qft_prob(y, m, target_v, n_mod, base_a);
        p_minspm := minspm_aqft_prob(y, m, target_v, n_mod, base_a, K);
