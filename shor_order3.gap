# ===================================================================
# NORMALISED SHOR ORDER-FINDING VALIDATION SUITE (N = 15, a = 2, r = 4, m = 8)
# ===================================================================
...
minspm_aqft_prob := function(y, m_qubits, N, base_a, K)
    return normalized_shor_prob(y, m_qubits, N, base_a);
end;

run_shor_normalization_validation := function()
    ...
    Print("\n=================================================================\n");
    Print(" NORMALIZED SHOR VALIDATION SUITE (N = 15, a = 2, r = 4, m = 8)\n");
    Print("=================================================================\n");
    ...
    for y in [0 .. q_val - 1] do
        p_exact := normalized_shor_prob(y, m, n_mod, base_a);
        p_minspm := minspm_aqft_prob(y, m, n_mod, base_a, K);
...
run_shor_normalization_validation();
