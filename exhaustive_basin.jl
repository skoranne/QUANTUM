...
function run_exhaustive_basin_sweeper()
    ...
    println("Executing Exhaustive 3-Opt Basin Probing via MINSPM...")
    ...
    for gen in 1:max_generations
        ...
        if gen % 300 == 0 || gen == 1
            println("Generation $gen | Refined Basin Cost: $global_best_cost")
        end
    end
    ...
    println("New Record Cost Achieved: $integer_cost")
    println("Best Permutation Vector:")
    println(join(global_best_perm, " "))
    ...
    println("Successfully saved best permutation and integer objective to solution.txt")

    CUDA.reclaim()
end

run_exhaustive_basin_sweeper()
